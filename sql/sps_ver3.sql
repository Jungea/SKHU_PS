...
CREATE TABLE `project` (
  ...
  `language` int(11) NOT NULL COMMENT '사용언어 여러개',
  ...
  `subject` int(11) DEFAULT NULL COMMENT '과목 프로젝트\n디테일에 과목 없음 추가',
  `year` int(11) DEFAULT NULL COMMENT '경진대회 출품작-참여연도',
  `semester` int(11) DEFAULT NULL COMMENT '경진대회 출품작-참여학기',
  PRIMARY KEY (`project_id`),
  KEY `fk_PROJECT_DETAIL1_idx` (`subject`),
  KEY `fk_PROJECT_DETAIL2_idx` (`language`),
...
CREATE TABLE `user` (
  ...
  `det_dept_id` int(11) NOT NULL COMMENT '학과 상세 id',
  ...
  KEY `fk_USER_DETAIL2_idx` (`language`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2020-04-22 17:23:47
