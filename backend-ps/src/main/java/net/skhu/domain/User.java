...
@Data
@ToString(exclude = { "projects", "projectJoins","projectStars", "todos","posts","comments", "timelines","postLikes"})
@EqualsAndHashCode(exclude = { "projects", "projectJoins","projectStars", "todos","posts","comments", "timelines","postLikes" })
@Entity
public class User {
   @Id
